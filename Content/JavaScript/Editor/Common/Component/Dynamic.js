...
class Dynamic extends React.Component {
    ...
    render() {
        ...
        const actionTypeData = Action_1.scheme.GetScheme(action.Name);
        return (React.createElement(Any_1.Any, { Value: action.Params, Type: actionTypeData, OnModify: this.Modify, PrefixElement: React.createElement(react_umg_1.HorizontalBox, null,
                prefixElement,
                React.createElement(CommonComponent_1.List, { Items: Action_1.scheme.GetActionNames(dynamicType.Filter), Selected: action.Name, OnSelectChanged: this.Select, Tip: actionTypeData.Meta.Tip }),
