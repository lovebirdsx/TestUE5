...
class Dynamic extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Any_1.Any, { Value: action.Params, Type: actionTypeData, OnModify: this.Modify, PrefixElement: React.createElement(react_umg_1.HorizontalBox, null,
                prefixElement,
                React.createElement(CommonComponent_1.List, { Items: Public_1.actionRegistry.GetActionNames(dynamicType.Filter), Selected: action.Name, OnSelectChanged: this.Select, Tip: actionTypeData.Meta.Tip }),
