...
const FlowList_2 = require("./FlowList");
...
class FlowEditor extends React.Component {
    ...
    LoadState(path) {
        ...
        // 加载剧情配置
        const flowListConfig = FlowList_1.FlowListOp.Load(this.ConfigFile.FlowConfigPath);
        return {
    ...
    Save = () => {
        ...
        const flowListToSave = (0, immer_1.default)(this.FlowList, (draft) => {
            const removeCount = FlowList_1.FlowListOp.FormatTexts(draft);
            if (removeCount > 0) {
                (0, Log_1.log)(`remove ${removeCount} text ids`);
            }
        });
        FlowList_1.FlowListOp.Save(flowListToSave, this.ConfigFile.FlowConfigPath);
        this.setState({
            Saved: this.FlowList,
        });
    };
        ...
        return (React.createElement(react_umg_1.VerticalBox, null,
            React.createElement(react_umg_1.Border, { BrushColor: (0, Color_1.formatColor)('#060606 ue back') },
                React.createElement(react_umg_1.VerticalBox, null,
                    ...
                    React.createElement(react_umg_1.HorizontalBox, null,
                        ...
                        React.createElement(CommonComponent_1.Btn, { Text: '导入', OnClick: this.Import, Tip: '从CSV中导入对话' }),
                        React.createElement(CommonComponent_1.Btn, { Text: '导出', OnClick: this.Export, Tip: '导出对话列表到CSV文件中' })),
            ...
            React.createElement(react_umg_1.ScrollBox, { Slot: scrollBoxSlot },
                React.createElement(ErrorBoundary_1.ErrorBoundary, null,
                    React.createElement(FlowList_2.FlowList, { FlowList: this.FlowList, OnModify: this.ModifyFlowList })))));
    }
}
