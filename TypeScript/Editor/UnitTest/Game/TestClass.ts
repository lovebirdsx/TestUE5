...
import { getClassObj, isChildOf, isChildOfClass, isType } from '../../../Common/Class';
import { assertTrue, test } from '../../../Editor/Common/Test';
...
export default function testClass(): void {
    test('is child of class', () => {
        const classObj = getClassObj(TsTrigger);
