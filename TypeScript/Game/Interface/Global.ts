import { IGlobalConfig } from './IGlobal';
...
export const globalConfig: IGlobalConfig = {
    ...
    BlueprintModelConfigPath: 'Content/Data/Json/BlueprintModel.json',
    DynamicModelBluePrintPath: 'Blueprints/ExtendedEntity/Dynamic',
    LevelsConfigPath: 'Content/Data/Json/Level.json',
    LevelsDataDir: 'Content/Data/Levels',
